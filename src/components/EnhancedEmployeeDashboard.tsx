      ...
      <Tabs defaultValue="cycles" className="w-full">
        ...
        <TabsContent value="cycles" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {employeeCycleInfoList.map((cycle, idx) => {
              const cycleDetail = employeeCycleDetails[idx]
              return (
                <Card key={cycle.id || idx} className="refresquitos-card">
                  <CardHeader>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {/* Métricas y acciones del ciclo, usando cycleDetail */}
                    {cycleDetail && (
                      <>
